...
import {FastGroupsToggleRowWidget} from "./fast_groups_muter.js";

/**
 * Fast Groups Bypasser Remote implementation that extends BaseFastGroupsModeChanger
 * and adds boolean input support for remote control.
 */
export class FastGroupsBypasserRemote extends BaseFastGroupsModeChanger {
